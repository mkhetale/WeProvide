    ...
    var body: some View {
        VStack {
            ...
            Text("Enter changes required for the task")
                .padding(.top,30)
            TextEditor(text: $providerCaption)
                .foregroundColor(.black)
//                .padding(.top, 30)
                .frame(width: 350, height: /*@START_MENU_TOKEN@*/100/*@END_MENU_TOKEN@*/)
                .border(/*@START_MENU_TOKEN@*/Color.black/*@END_MENU_TOKEN@*/, width: /*@START_MENU_TOKEN@*/1/*@END_MENU_TOKEN@*/)
            CustomText(text: $providerPrice, placeholder: Text("Request amount change"), imageName: "dollarsign.circle")
                .padding()
//                .background(Color(#colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1)))
            ...
            Button(action: {
                viewModel.updateQuote(providerPrice: providerPrice, providerCaption: providerCaption, quote: quote, price: quote.price, caption: quote.caption)
                show.toggle()
            }, label: {
                Text("Update Quote")
            })
